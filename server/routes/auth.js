...
async function getSteamUserData(steamId64) {
  ...
  // Метод 1: Публичный JSON endpoint Steam (не требует API ключа)
  try {
    const jsonUrl = `https://steamcommunity.com/profiles/${steamId64}/?xml=1`;
    console.log('🌐 Method 1: Fetching Steam JSON:', jsonUrl);
    ...
    const xmlData = jsonResponse.data;
