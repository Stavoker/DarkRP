...
function Shelves() {
  return (
    <div>
      ...
      <div className="flex flex-col xl:flex-row xl:gap-[40px] gap-[15px] xl:pb-[80px] pb-[45px]">
        <aside className="flex xl:flex-col flex-row gap-[48px] xl:w-[200px] shrink-0 xl:mt-[78px] order-1 xl:order-1 max-xl:px-[20px] xl:sticky xl:top-[120px] xl:self-start xl:max-h-[calc(100vh-140px)] xl:overflow-y-auto xl:pr-[10px] scrollbar-hide">
        ...
        <div className="flex flex-col xl:items-end xl:text-right space-y-[5px] xl:min-w-[250px] xl:mt-[50px] order-2 xl:order-3 max-xl:px-[20px] xl:sticky xl:top-[120px] xl:self-start xl:max-h-[calc(100vh-140px)] xl:overflow-y-auto">
          ...
          <div className="max-xl:flex max-xl:flex-row max-xl:justify-between max-xl:items-center max-xl:gap-[10px] space-y-[5px]">
            <p className="text-accent-primary xl:text-[22px] text-[16px] font-light mb-[10px]">The default</p>
            <p className="text-accent-primary xl:text-[22px] text-[16px] font-light mb-[10px]">By name</p>
            <p className="text-accent-primary xl:text-[22px] text-[16px] font-light mb-[10px]">By creation date</p>
            <p className="text-accent-primary xl:text-[22px] text-[16px] font-light mb-[10px]">By update date</p>
          </div>
        </div>
      </div>
    </div>
